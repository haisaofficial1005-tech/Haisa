...
export default function SessionErrorBoundary({ error, onRetry }: SessionErrorProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="bg-slate-800/50 rounded-xl p-8 max-w-md w-full text-center border border-slate-700">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Sesi Berakhir</h2>
        <p className="text-slate-400 mb-6">
          {error || 'Sesi login Anda telah berakhir. Silakan login kembali untuk melanjutkan.'}
        </p>
        ...
        <p className="text-slate-500 text-sm mt-4">
          Otomatis mengarahkan ke login dalam {countdown} detik...
        </p>
      </div>
    </div>
  );
