/**
 * Sign-in page
 * Requirement 1.1: Redirect to Google OAuth authentication flow
 */
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">Haisa WA</h2>
          <p className="mt-2 text-gray-600">Sign in to manage your complaints</p>
        </div>
